...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div(['Input Launch Site:', dcc.Dropdown(id='site-dropdown', options=[
...
def get_pie_chart(entered_site):
    if entered_site == 'All':
        ...
        sclass_counts = fil_df['Launch Site'].value_counts().reset_index()
        sclass_counts.columns = ['Launch Site', 'counts']
        fig = px.pie(sclass_counts, values='counts', 
        names='Launch Site', 
